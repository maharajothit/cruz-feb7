...
module.exports.createUser = function (credentials, user, callback) {
    ...
    console.log("--cognitouser credential---"+JSON.stringify(credentials))
    console.log("--reached- cognitouser--"+JSON.stringify(user))
    // create params for user creation
    var params = {
        UserPoolId: user.user_pool_id, /* required */
    ...
    console.log("---cognitoUser-----"+JSON.stringify(params))
